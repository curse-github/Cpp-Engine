...
Vector3 Vector3::operator*(double b) { return Vector3(x*((float)b), y*((float)b), z*((float)b)); }
Vector3 Vector3::operator*(int b) { return Vector3(x*((float)b), y*((float)b), z*((float)b)); }
Vector3 Vector3::operator/(float b) { return Vector3(x/b, y/b, z/b); }
Vector3 Vector3::operator/(double b) { return Vector3(x/((float)b), y/((float)b), z/((float)b)); }
Vector3 Vector3::operator/(int b) { return Vector3(x/((float)b), y/((float)b), z/((float)b)); }
...
Vector4 Vector4::operator*(double b) { return Vector4(x*((float)b), y*((float)b), z*((float)b), w*((float)b)); }
Vector4 Vector4::operator*(int b) { return Vector4(x*((float)b), y*((float)b), z*((float)b), w*((float)b)); }
Vector4 Vector4::operator/(float b) { return Vector4(x/b, y/b, z/b, w/b); }
Vector4 Vector4::operator/(double b) { return Vector4(x/((float)b), y/((float)b), z/((float)b), w/((float)b)); }
Vector4 Vector4::operator/(int b) { return Vector4(x/((float)b), y/((float)b), z/((float)b), w/((float)b)); }
